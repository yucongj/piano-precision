...
(Get-Content $in) -replace '@VERSION@', $version -replace '@REDIST_VER@', $redist_ver -replace '@NAME@', $full_name -replace '@CONDENSED@', $full_condensed -replace '@SCORES@', $scores -replace '@RECORDINGS@', $recordings -replace '@W@', '<!-- DO NOT EDIT THIS FILE: it is auto-generated -->' | Out-File -encoding ASCII $wxs
